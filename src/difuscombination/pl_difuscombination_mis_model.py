...
class DifusCombinationMISModel(MISModelBase):
    def __init__(self, config: Config | None = None) -> None:
        ...
        ) if config.training_samples_file is not None else None
        ...
        ) if config.test_samples_file is not None else None
        ...
        ) if config.validation_samples_file is not None else None
